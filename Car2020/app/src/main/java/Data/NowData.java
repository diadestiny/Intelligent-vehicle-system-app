...
public class NowData {
    ...
    static int speed = 115200;//车速
    static String temperature = "0" ;//车温
    ...
    public static void setDrunk(String drunk) {
        NowData.drunk = drunk;
    }

    public static String getTired() {
        return tired;
    }
    ...
    public static String gethBlood() {
        return hBlood;
    }
