...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private SwitchPreferenceCompat databaseTestPreference;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        databaseTestPreference=(SwitchPreferenceCompat) getPreferenceManager().findPreference("database_test");
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        if(Constant.KEY_AIUI_WAKEUP.equals(s)) {
            boolean wakeUpEnable = sharedPreferences.getBoolean(s, true);
            if(wakeUpEnable) {
                eosPreference.setEnabled(true);
            } else {
                eosPreference.setEnabled(false);
